...
#ifndef FILE_NISSAN_360_4_H_SEEN
#define FILE_NISSAN_360_4_H_SEEN
...
#define NUMBER_OF_REAL_EVENTS     8
#define NUMBER_OF_VIRTUAL_EVENTS  8
#define AMBIGUOUS_COUNT           0xFF //NA to the SR20
