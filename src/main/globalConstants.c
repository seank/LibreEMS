...
const volatile unsigned short IATTransferTable[1024]; /* 2k */
const volatile unsigned short CHTTransferTable[1024]; /* 2k */
const volatile unsigned short MAFTransferTable[1024]; /* 2k */
const volatile unsigned char TestTransferTable[2048]; /* 2k */


const unsigned char interfaceVersion[INTERFACE_VERSION_LENGTH];
const unsigned char firmwareVersion[FIRMWARE_VERSION_LENGTH];
const unsigned char buildTimeAndDate[FIRMWARE_BUILD_DATE_LENGTH];
const unsigned char compilerVersion[COMPILER_VERSION_LENGTH];
const unsigned char operatingSystem[OPERATING_SYSTEM_LENGTH];


/* Injection (currently used for both inj and ign) */
const unsigned char injectorMainOnMasks[ECT_OUTPUT_CHANNELS];
const unsigned char injectorMainOffMasks[ECT_OUTPUT_CHANNELS];
const unsigned char injectorMainActiveMasks[ECT_OUTPUT_CHANNELS];
const unsigned char injectorMainEnableMasks[ECT_OUTPUT_CHANNELS];
const unsigned char injectorMainDisableMasks[ECT_OUTPUT_CHANNELS];
const unsigned char injectorMainGoHighMasks[ECT_OUTPUT_CHANNELS];
const unsigned char injectorMainGoLowMasks[ECT_OUTPUT_CHANNELS];
