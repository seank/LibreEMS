...
typedef struct {
	...
	unsigned char  cylinderCount;		 	///< The number of cylinders your engine has  */
	unsigned char  strokesPerCycle;    	///< The number of strokes needed to complete an engine cycle  */
...
typedef struct {
	...
	unsigned char correspondingCylinder[MAX_NUMBER_OF_OUTPUT_EVENTS];
